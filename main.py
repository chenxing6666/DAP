...
if __name__ == '__main__':
    ...
    elif config == 'ltcifar100_dap':
        from configs.ltcifar100_dap import get_args_parser
        config_parser = subparser.add_parser('ltcifar100_dap', help='Split-ltCIFAR100 L2P configs')
