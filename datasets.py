...
from imbalancedcifar100 import IMBALANCECIFAR100
import utils
...
def get_dataset(dataset, transform_train, transform_val, args,):
    ...
    elif dataset == 'ltCIFAR100':
        dataset_train = IMBALANCECIFAR100(args.data_path, imb_factor=0.002,imb_type=args.imbtype,train=True, download=True, transform=transform_train)
        dataset_val = datasets.CIFAR100(args.data_path, train=False, download=True, transform=transform_val)
