...
def get_args_parser(subparsers):
    subparsers.add_argument('--batch-size', default=80, type=int, help='Batch size per device')
    ...
    # Data parameters
    subparsers.add_argument('--loadmodel_dir', default='./baloutput', help='path where to load the model')
    
    subparsers.add_argument('--data-path', default='/local_datasets/', type=str, help='dataset path')
    subparsers.add_argument('--dataset', default='Split-ltCIFAR100', type=str, help='dataset name')
    subparsers.add_argument('--imbtype', default='exp_max', type=str, help='ltCIFAR100 imbtype')
    
    subparsers.add_argument('--shuffle', action='store_true', help='shuffle the dataset')
    ...
    subparsers.add_argument('--reverse', action='store_true', help='reverse the data order')
